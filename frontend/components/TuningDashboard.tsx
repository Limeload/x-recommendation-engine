...
const feedPrefsConfig = [
  {
    key: 'in_network_boost',
    label: 'Network Preference',
    icon: Users,
    default: 0.3,
    leftLabel: 'Global',
    rightLabel: 'Friends First',
  },
  {
    key: 'virality_boost',
    label: 'Content Style',
...
const topicConfig = [
  { key: 'tech_affinity', label: 'Tech / AI / Engineering', icon: Cpu, default: 0.7 },
  { key: 'politics_affinity', label: 'Politics / Policy', icon: Flag, default: 0.3 },
  { key: 'culture_affinity', label: 'Culture / Entertainment', icon: Hash, default: 0.5 },
];
...
const SLIDER_CLASS = 'w-full h-1.5 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-gray-800';
const VALUE_BADGE_CLASS = 'text-sm font-mono font-semibold bg-gray-100 px-2 py-0.5 rounded text-gray-900';
      ...
      <div className="p-5 overflow-y-auto flex-1 space-y-6">
            ...
            {coreConfig.map(({ key, label, description, icon: Icon }) => (
              <div key={key}>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className={VALUE_BADGE_CLASS}>
        ...
        <section>
          ...
          <div className="space-y-5">
            {feedPrefsConfig.map(({ key, label, icon: Icon, default: def, leftLabel, rightLabel }) => (
              <div key={key}>
                <div className="flex items-center justify-between mb-1">
                  <label className="flex items-center text-sm font-medium text-gray-900">
                    <Icon size={15} weight="bold" className="mr-2 text-gray-600" />
        ...
        <section>
          ...
          <div className="space-y-4">
            {topicConfig.map(({ key, label, icon: Icon, default: def }) => (
              <div key={key}>
                <div className="flex items-center justify-between mb-1">
                  <label className="flex items-center text-sm font-medium text-gray-900">
                    <Icon size={15} weight="bold" className="mr-2 text-gray-600" />
          ...
          <p className="text-xs text-gray-400 mt-3">
            0 = suppress · 0.5 = neutral · 1 = strongly prefer
          </p>
        </section>
